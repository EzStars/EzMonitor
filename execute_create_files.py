...
# -*- coding: utf-8 -*-
"""
Direct file creation script
This script creates the API files needed for the monitor-app project.
"""
...
def create_files():
    """Create the required files in the monitor-app project."""
    ...
    try:
        ...
        print(f"✓ Created directory: {types_dir}")
