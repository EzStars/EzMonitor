...
- `/performance`：性能测试（long task、Navigation/Resource/User Timing）
...
默认上报地址为 `http://localhost:3001/api/monitor/batch`，可通过 `VITE_MONITOR_REPORT_URL` 覆盖。
...
- 默认：`http://localhost:3001/api/monitor/batch`
