...
fs.writeFileSync(path.join(typesDir, 'api.ts'), apiTypesContent, 'utf8');
...
fs.writeFileSync(path.join(apiDir, 'client.ts'), clientContent, 'utf8');
console.log('Created: src/api/client.ts');
...
fs.writeFileSync(path.join(apiDir, 'index.ts'), indexContent, 'utf8');
console.log('Created: src/api/index.ts');
