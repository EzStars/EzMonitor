...
const baseDir = path.join(__dirname, '..', 'monitor-app', 'src');
...
// Create types/api.ts
const apiTypesPath = path.join(typesDir, 'api.ts');
...
fs.writeFileSync(apiTypesPath, apiTypesContent, 'utf-8');
console.log(`Created: ${apiTypesPath}`);

// Create api/client.ts
const clientPath = path.join(apiDir, 'client.ts');
