...
// 你可以在这里预注册一些核心插件
// import { PerformancePlugin, ErrorPlugin } from '@ezmonitor/sdkv2/plugins';
// sdk.pluginManager.register(new PerformancePlugin());
// sdk.pluginManager.register(new ErrorPlugin());
